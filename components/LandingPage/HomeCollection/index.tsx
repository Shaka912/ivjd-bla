...
const CardCollectionItems = ({ src, title }: any) => {
  const backgroundStyle = {
    background: `linear-gradient(180deg, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.40) 100%), url(${src}) lightgray 100% / cover no-repeat`,
  };
  return (
    <div className="flex relative flex-col pt-20  w-full aspect-[1.54]">
      ...
      />
      <h1 className="relative font-normal text-[18px] text-[#ffffff] px-2 py-5 mt-20">
        {title}
      </h1>
    </div>
  );
